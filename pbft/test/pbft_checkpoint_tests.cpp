...
namespace bzn::test
{
    ...
    TEST_F(pbft_checkpoint_test, test_checkpoint_messages_sent_on_execute)
    {
        ...
        this->build_pbft();
        this->service_execute_handler(this->request_hash, CHECKPOINT_INTERVAL);
    }
    ...
    TEST_F(pbft_checkpoint_test, unstable_checkpoint_does_not_discard_stable_checkpoint)
    {
        ...
        this->service_execute_handler(this->request_hash, CHECKPOINT_INTERVAL*2);
    ...
    TEST_F(pbft_checkpoint_test, stable_checkpoint_discards_old_state)
    {
        ...
        for (auto i : boost::irange(1, 10))
        {
            ...
            msg.set_view(1);
            msg.set_sequence(i);
            msg.set_request(this->request_msg.SerializeAsString());
            msg.set_request_hash(this->crypto->hash(msg.request()));
